...
void loop() {
  ...
  if ((V) && (B)) //&& é a função lógica and (multiplicação)
  ...
  if ((V == true) || (B == true))// || significa função lógica ou (soma)
     digitalWrite(led_vd, HIGH);      
  else        
     digitalWrite(led_vd, LOW);  
  if (V ^ B) // ^ significa a função lógica xor ( sinais diferentes ligado ou "1"), (sinas iguais desligado ou "0")
